...
namespace Sumantablog\Admin\ApiTester;
...
trait BootExtension
{
    ...
    protected static function registerRoutes()
    {
        parent::routes(function ($router) {
            ...
            $router->get('api-tester', 'Sumantablog\Admin\ApiTester\ApiTesterController@index')->name('api-tester-index');
            $router->post('api-tester/handle', 'Sumantablog\Admin\ApiTester\ApiTesterController@handle')->name('api-tester-handle');
        });
    }
